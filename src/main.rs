...
fn part2(lines: &Vec<String>) -> i64 {
    ...
    */
    ...
    let chunk_radius: i64 = ((num_steps - height / 2) / height).try_into().unwrap();
    ...
    let num_odd_corners = -1 * (chunk_radius + 1); // Odd corners are removed
...
fn count_reachable(reachable: &Vec<Vec<bool>>, start_x: usize, end_x: usize, start_y: usize, end_y: usize) -> i32 {
